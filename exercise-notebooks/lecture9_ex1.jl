md"""
## Exercise 1 - **Advanced data transfer optimisations (part 1)**
"""
...
👉 Download the [`lecture9_ex1.ipynb`](https://github.com/eth-vaw-glaciology/course-101-0250-00/blob/main/exercise-notebooks/notebooks/lecture9_ex1.ipynb) notebook and edit it *(you should have a copy on it in your `lecture09` folder on octopus)*.
"""
