...
#nb # > 💡 note: You can follow the lecturealong live from the Moodle-based JupyterHub server.
#md # \note{You can follow the lecturealong live from the Moodle-based JupyterHub server.}
