...
#nb # > 💡 hint: Make sure to update the flux array initialisation and include the flux in the y-direction `qy` and use now 2D arrays: `qx,qy = zeros(nx-1,??), zeros(??,ny-1)`.
...
#md # ~~~
# <center>
#   <video width="50%" autoplay loop controls src="./figures/l4_heatmap_arrows.mp4"/>
# </center>
#md # ~~~
