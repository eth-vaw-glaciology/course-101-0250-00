...
#nb # > 💡 hint: Refer to [this section](#timer_and_performance) in lecture 6 to capture the starting point describing which features are specific to each version of the diffusion 2D codes.
