...
#nb # <center>
#nb #  <video width="80%" autoplay loop controls src="../assets/literate_figures/l1_porous_convection_2D.mp4"/>
#nb # </center>
...
In addition, to reduce the number of independent variables in the code, instead of using the Fourier heat flux $\boldsymbol{q_T}$ we use the temperature diffusion flux $\boldsymbol{q_T}=\boldsymbol{q_F}/(\rho_0 c_p)$.
"""
